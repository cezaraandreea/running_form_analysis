...
from src.pipeline.pose_estimation import PoseEstimator, PoseFrame
...
def _reencode_h264(input_path: str, output_path: str) -> bool:
    ...
    try:
        ...
        return False
from src.pipeline.biomechanics import BiomechanicsCalculator, BiomechanicsFrame
from src.pipeline.gait_analysis import GaitAnalysisResult, analyze_gait_phases
from src.services.analysis import RunningAnalyzer
